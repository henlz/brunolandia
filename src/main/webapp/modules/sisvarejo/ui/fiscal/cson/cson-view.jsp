...
<html xmlns:ng="http://angularjs.org" lang="pt">
    ...
    <md-toolbar class="md-tall md-toolbar-main">
        ...
        <md-button class="md-fab md-primary md-hue-2 grid-add-button" aria-label="Adicionar" ng-click="abrirPopupNovoCSON($event)">
    ...
    <bottomsheet>
        <div class="bottom-sheet-content">
            ...
            <div class="right-content">
                <md-button class="md-raised" aria-label="Excluir" ng-click="excluirCson($event, model.itensExcluir)"><i class="md-icon-delete md-icon-lg"></i></md-button>
            </div>
        </div>
    </bottomsheet>
