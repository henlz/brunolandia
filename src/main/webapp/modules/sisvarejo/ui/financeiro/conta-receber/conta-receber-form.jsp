...
<md-content layout-align="center center" layout="column" layout-margin layout-padding>
    ...
    <section layout-fill>
        <form name="contaReceberForm" layout-padding layout="column" layout-align="start center" width="90%">
            <md-subheader>
                <h3 ng-if="currentState == INSERT_STATE">Nova Conta a Receber</h3>
                <h3 ng-if="currentState == CANCEL_STATE">Cancelar Conta a Receber</h3>
                <h3 ng-if="currentState == PAY_STATE">Informar pagamento - Conta a Receber</h3>
            </md-subheader>
            ...
            <md-content layout="row" layout-margin ng-if="currentState == CANCEL_STATE || currentState == PAY_STATE">
                <md-input-container class="md-block">
                    ...
                    <div ng-messages="contaReceberForm.observacao.$error">
                ...
                <md-button class="md-primary md-fab" ng-click="cancelarContaReceber(model.entidade)" ng-if="currentState == CANCEL_STATE">
                    <i class="md-icon md-icon-cancel"></i>
                </md-button>
                <md-button class="md-primary md-fab" ng-click="pagarContaReceber(model.entidade)" ng-if="currentState == PAY_STATE">
            ...
            <md-content layout="row" layout-margin>
                ...
                <md-input-container>
                    ...
                    <div ng-messages="contaReceberForm.numero.$error" ng-if="currentState == INSERT_STATE">
                        <div ng-message="required">
                            Campo obrigatório.
                        </div>
                    </div>
                ...
                <md-input-container>
                    ...
                    <div ng-messages="contaReceberForm.serie.$error" ng-if="currentState == INSERT_STATE">
                        <div ng-message="required">
                            Campo obrigatório.
                        </div>
                    </div>
                ...
                <md-input-container>
                    ...
                    <div ng-messages="contaReceberForm.modelo.$error" ng-if="currentState == INSERT_STATE">
                        <div ng-message="required">
                            Campo obrigatório.
                        </div>
                    </div>
                ...
                <div layout="row" layout-align="center center">
                    ...
                    <md-input-container>
                        ...
                        <div ng-messages="contaReceberForm.cliente.$error" ng-if="currentState == INSERT_STATE">
                            <div ng-message="required">
                                Campo obrigatório.
                            </div>
                        </div>
    ...
    <md-content layout="row" layout-align="center center" style="width:100%;">
        ...
        <md-input-container>
            ...
            <div ng-messages="contaReceberForm.valor.$error" ng-if="currentState == INSERT_STATE">
                <div ng-message="required">
                    Campo obrigatório.
                </div>
            </div>
        ...
        <md-input-container>
            ...
            <div ng-messages="contaReceberForm.numeroParcela.$error" ng-if="currentState == INSERT_STATE">
                <div ng-message="required">
                    Campo obrigatório.
                </div>
            </div>
        ...
        <md-input-container>
            ...
            <div ng-messages="contaReceberForm.dataEmissao.$error" ng-if="currentState == INSERT_STATE">
                <div ng-message="required">
                    Campo obrigatório.
                </div>
            </div>
    ...
    <md-content layout="row" layout-align="center center" style="width:100%;">
        ...
        <md-input-container>
            ...
            <div ng-messages="contaReceberForm.descricao.$error" ng-if="currentState == INSERT_STATE">
                <div ng-message="required">
                    Campo obrigatório.
                </div>
            </div>
        ...
        <div layout="row" layout-align="center center">
            ...
            <md-input-container>
                ...
                <div ng-messages="contaReceberForm.formaPagamento.$error" ng-if="currentState == INSERT_STATE">
                    <div ng-message="required">
                        Campo obrigatório.
                    </div>
                </div>
    ...
    <section layout="row" layout-align="start center" layout-fill layout-margin>
        ...
        <md-content width="100%" layout-padding layout="row" layout-align="end end">
            ...
            <md-button class="md-icon-button md-fab" ui-sref="conta-receber.listar" aria-label="Cancelar cadastro">
            ...
            <md-button class="md-primary md-icon-button md-fab" ng-if="currentState == INSERT_STATE"
                       ng-click="salvarContaReceber(model.entidade)"
                       aria-label="Salvar conta a receber">
