    ...
    <md-data-table-container>
        <table md-data-table md-row-select="model.selected">
            ...
            <tr>
                ...
                <th order-by="sigla" style="width: 15%;">Sigla</th>
                <th order-by="nome">Nome</th>
            </tr>
            </thead>
            <tbody>
            <tr ng-repeat="tamanho in model.content | orderBy: model.query.order" ng-click="itemClicked($event, tamanho)" md-auto-select>
                <td>{{::tamanho.id}}</td>
                <td>{{::tamanho.sigla}}</td>
                <td>{{::tamanho.nome}}</td>
            </tr>
    ...
    <bottomsheet>
        <div class="bottom-sheet-content">
            ...
            <div class="right-content">
                <md-button class="md-raised" aria-label="Excluir" ng-click="excluirTamanhos($event, model.itensExcluir)"><i class="md-icon-delete md-icon-lg"></i></md-button>
            </div>
        </div>
    </bottomsheet>
