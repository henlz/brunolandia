(function (angular) {
    ...
    angular.module('sisvarejo').controller('ContaPagarController', function ($scope, $rootScope, $state, $http, $mdToast, $window, $log, $injector, $importService, $mdDialog, $mdBottomSheet) {
         ...
         */
        $scope.LIST_STATE = "conta-pagar.listar";
        /**
         * Variável estática que representa
         * o estado de detalhe de um registro.
         */
        $scope.DETAIL_STATE = "conta-pagar.detalhe";
        /**
         * Variável estática que representa
         * o estado para a criação de registros.
         */
        $scope.INSERT_STATE = "conta-pagar.cadastrar";
        /**
         * Variável estática que representa
         * o estado para a edição de registros.
         */
        $scope.CANCEL_STATE = "conta-pagar.cancelar";

        /**
         *
         * @type {string}
         */
        $scope.PAY_STATE = "conta-pagar.pagar";
        ...
        $scope.changeToInsert = function () {
            ...
            $scope.model.entidade = new ContaPagar();
        ...
        $scope.changeToCancel = function (id) {
            ...
            financeiroService.findContaPagarById(id, {
        ...
        $scope.salvarContaPagar = function (entidade) {
            financeiroService.insertContaPagar(entidade, {
                callback: function (result) {
                    $state.go($scope.LIST_STATE);
                },
                errorHandler: function (message, exception) {
         ...
         *
         */
        $scope.pagarContaPagar = function (contaPagar) {
            financeiroService.pagarContaPagar(contaPagar, {
                callback: function () {
                    $state.go($scope.LIST_STATE);
                },
         ...
         *
         */
        $scope.cancelarContaPagar = function (contaPagar) {
            financeiroService.cancelarContaPagar(contaPagar, {
                callback: function () {
                    $state.go($scope.LIST_STATE);
                },
                errorHandler: function (message, error) {
        ...
        $scope.abrirPopupFormaPagamento = function (ev) {
            ...
            $scope.clienteDialog.show({
                ...
                templateUrl: './modules/sisvarejo/ui/financeiro/conta-pagar/popup/popup-busca-forma-pagamento.html',
                targetEvent: ev,
                hasBackdrop: true,
                locals: {
                    local: [$scope]
