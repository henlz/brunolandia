...
.value('taOptions',  {
	toolbar: [
		...
		['justifyLeft','justifyCenter','justifyRight','indent','outdent', 'insertImage']
	],
	classes: {
		focussed: "focussed",
		toolbar: "btn-toolbar",
...
.value('taTranslations', {
	...
	insertImage: {
		...
		dialogPrompt: 'Por favor insira a URL da imagem para inserir',
	...
	insertVideo: {
		...
		tooltip: 'Inserir video',
		dialogPrompt: 'Por favor insira a URL da vídeo do youtube para inserir'
	},
	insertLink: {
		//tooltip: 'Insert / edit link',
		//dialogPrompt: "Please enter a URL to insert"
		tooltip: 'Inserir / editar link',
		dialogPrompt: "Por favor insira a URL"
	},
	editLink: {
		reLinkButton: {
			tooltip: "Relink"
