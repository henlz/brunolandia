...
public class Fornecedor extends AbstractEntity {
     ...
     */
    public Fornecedor(Long id, String razaoSocial, TipoPessoa tipoPessoa, String nomeFantasia, String representante, String email, String telefone, String fax, String cep, String bairro, String complemento, String cnpj, String uf, String endereco, Integer numero, Cidade cidade, Boolean transportadora, Condicao condicaoPagamento) {
        super(id);
