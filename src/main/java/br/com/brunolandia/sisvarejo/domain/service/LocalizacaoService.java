...
public class LocalizacaoService {
     ...
     * @return
     */
    public List<Cidade> listCidadesByFilters(String nome, Estado estado, Long id) {
        return this.cidadeRepository.listByFilters(nome, estado != null ? estado.getId() : null, id);
    }
