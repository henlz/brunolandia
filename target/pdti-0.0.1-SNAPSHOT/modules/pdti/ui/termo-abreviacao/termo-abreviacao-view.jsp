...
<html xmlns:ng="http://angularjs.org" lang="pt">
    ...
    <md-toolbar class="md-tall md-toolbar-main" layout="row" layout-align="center center">
        <eits-search-tags width="100%" placeholder="Digite sua pesquisa" min-length="0" change-tag="changeTags" tags="tags" tags-string="model.tagsString"></eits-search-tags>
    ...
    <!--<eits-table id="table" content="currentPage.content" multi-selection="true" on-selection-change="selectionUpdate(selectedItens)" on-item-click="itemClicked(item)">-->
        <!--<columns>-->
            <!--<table-column header="Abreviação" field="abreviacao" sortable="true" width="10%"/>-->
            <!--<table-column header="Termo" field="termo" sortable="true"/>            -->
        <!--</columns>-->
    <!--</eits-table>-->
    ...
    <md-data-table-container>
        <table md-data-table md-row-select="model.selected">
            ...
            <tr>
                <th order-by="abreviacao" style="width: 30%;">Abreviação</th>
                <th order-by="termo">Termo</th>
            </tr>
            </thead>
            <tbody>
            <tr ng-repeat="termo in currentPage.content | orderBy: model.query.order" ng-click="itemClicked($event, termo)" md-auto-select>
                <td>{{::termo.abreviacao}}</td>
                <td>{{::termo.termo}}</td>
            </tr>
            </tbody>
        </table>
    ...
    <bottomsheet>
        <div class="bottom-sheet-content">
            ...
            <div class="right-content">
                <md-button class="md-raised" aria-label="Excluir" ng-click="excluirTermoAbreviacao($event, model.itensExcluir)"><i class="md-icon-delete md-icon-lg"></i></md-button>
            </div>
        </div>
    </bottomsheet>
