...
<html xmlns:ng="http://angularjs.org" lang="pt">
    ...
    <md-toolbar class="md-tall md-toolbar-main" layout="row" layout-align="center center">
        <eits-search-tags width="100%" placeholder="Digite sua pesquisa" min-length="1" change-tag="changeTags" tags="tags" tags-string="model.tagsString"></eits-search-tags>
    ...
    <!--<eits-table id="table" content="currentPage.content" multi-selection="true" on-selection-change="selectionUpdate(selectedItens)" on-item-click="itemClicked(item)">-->
        <!--<columns>-->
            ...
            <!--<table-column header="Origem" field="documentoReferencia.sigla" sortable="true" width="40%">-->
                <!--<column-template>-->
    ...
    <md-data-table-container>
        <table md-data-table md-row-select="model.selected">
            ...
            <tbody>
            <tr ng-repeat="principio in currentPage.content | orderBy: model.query.order" ng-click="itemClicked($event, principio)">
                <td>{{::principio.descricao}}</td>
                <td>
                    {{:: principio.documentoReferencia.sigla == "" ? principio.documentoReferencia.titulo : principio.documentoReferencia.sigla }}
                </td>
            </tr>
            </tbody>
        </table>
    ...
    <bottomsheet>
        <div class="bottom-sheet-content">
            ...
            <div class="right-content">
                <md-button class="md-raised" aria-label="Excluir" ng-click="excluirPrincipioDiretriz($event, model.itensExcluir)"><i class="md-icon-delete md-icon-lg"></i></md-button>
            </div>
        </div>
    </bottomsheet>
