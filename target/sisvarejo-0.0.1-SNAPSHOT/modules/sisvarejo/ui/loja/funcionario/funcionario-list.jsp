    ...
    <md-data-table-container>
        <table md-data-table>
            ...
            <tr ng-repeat="fornecedor in model.content | orderBy: model.query.order">
                ...
                <td layout="row">
                    <md-button class="md-icon-button" ui-sref="fornecedor.alterar({id: fornecedor.id})" aria-label="Alterar fornecedor">
                        <i class="md-icon md-icon-edit"></i>
                    </md-button>
                    <md-button class="md-icon-button" ng-click="excluirFornecedor($event, fornecedor)" aria-label="Excluir fornecedor">
