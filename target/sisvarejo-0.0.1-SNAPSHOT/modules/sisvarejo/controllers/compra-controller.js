    ...
    angular.module('sisvarejo').controller('CompraController', function ($scope, $rootScope, $state, $http, $mdToast, $window, $log, $injector, $importService, $mdDialog, $mdBottomSheet) {
        ...
        $scope.abrirPopupCliente = function (ev) {
            $mdDialog.show({
                ...
                templateUrl: './modules/sisvarejo/ui/loja/compra/popup/popup-busca-cliente.html',
                targetEvent: ev,
                hasBackdrop: true
            })
        ...
        $scope.abrirPopupProduto = function (ev) {
            $mdDialog.show({
                ...
                templateUrl: './modules/sisvarejo/ui/loja/compra/popup/popup-busca-produto.html',
                targetEvent: ev,
                hasBackdrop: true
            })
                .then(function (result) {
        ...
        $scope.abrirPopupAlterarProduto = function (ev, entidade) {
            $mdDialog.show({
                ...
                templateUrl: './modules/sisvarejo/ui/loja/compra/popup/popup-compra.html',
                targetEvent: ev,
                hasBackdrop: true,
